        ...
        <div class="panel-body">
            ...
            <c:if test="${not empty employeeList}">
                    ...
                    <div class="col-xs-8">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="col-md-6"><input type="text" name="searchName" id="searchName" value="${searchName}"></div>
                            </div>
                ...
                <div id="pagination" align="right">
                    <c:url value="//searchEmployee?searchName=${searchName}" var="prev">
                    ...
                    <c:forEach begin="1" end="${maxPages}" step="1" varStatus="i">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <c:url value="//searchEmployee?searchName=${searchName}" var="url">
                    ...
                    <c:url value="//searchEmployee?searchName=${searchName}" var="next">
                        <c:param name="page" value="${page + 1}"/>
                    </c:url>
